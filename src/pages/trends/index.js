...
const Trends = () => {
    ...
    return (
        <section className={`${styles.mainContainer} bg-background`}>
            <h1 className='text-4xl text-white'>Top Trends of the data</h1>
            <section className='flex flex-col mt-6 gap-6'>
                <h1 className='text-xl text-white underline'>Alerts Overview</h1>
            ...
            <section className='flex flex-col mt-6 gap-6'>
                <h1 className='text-xl text-white underline'>Ips overview</h1>
                <div className='flex flex-col gap-4 text-white'>
            ...
            <section className='flex flex-col mt-6 gap-6'>
                <h1 className='text-xl text-white underline'>Severity overview</h1>
                <div className='flex flex-col gap-4 text-white'>
